...
#pragma warning restore 0414 
        ...
        private bool InternalCharacterMove(ref Vector3 transientVelocity, float deltaTime)
        {
            ...
            for (int i = 0; i < _overlapsCount; i++)
            {
                ...
                if (Vector3.Dot(remainingMovementDirection, overlapNormal) < 0f)
                {
                    ...
                    InternalHandleVelocityProjection(
                        stableOnHit,
                        overlapNormal,
                        GetObstructionNormal(overlapNormal, stableOnHit),
                ...
                hitSomethingThisSweepIteration)
            {
                    ...
                    > 0)
                {
                    ...
                    Vector3 sweepMovement = (remainingMovementDirection * closestSweepHit.distance) + (closestSweepHit.normal * CollisionOffset);
                    ...
                    EvaluateHitStability(closestSweepHit.collider, closestSweepHit.normal, closestSweepHit.point, tmpMovedPosition, _transientRotation, transientVelocity, ref moveHitStabilityReport);
            ...
            ref MovementSweepState sweepState, ref Vector3 previousObstructionNormal, ref Vector3 transientVelocity, ref float remainingMovementMagnitude, ref Vector3 remainingMovementDirection)
        {
            ...
            else
            {
                ...
                {
                    Vector3 directionRight = Vector3.Cross(CharacterUp, originalDirection).normalized;
